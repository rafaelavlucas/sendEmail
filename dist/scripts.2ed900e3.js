...
var datacolors = ["gra-01", "gra-02", "gra-03", "gra-04", "gra-05", "gra-06"];
...
var accordionButton;
var accordionList = document.querySelector(".accordionList");
...
getCategories();
accordionButton = document.querySelectorAll(".accordion__button"); // Events

accordionButton.forEach(function (button) {
  button.addEventListener("click", openAccordion);
});
categoryBlockContent.addEventListener("scroll", addFadeOnScroll); // Functions
...
},{"./components/themes":"scripts/components/themes.ts","./components/accordion":"scripts/components/accordion.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
